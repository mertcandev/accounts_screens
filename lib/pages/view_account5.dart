...
class ViewAccount5 extends StatefulWidget {
  const ViewAccount5({Key? key}) : super(key: key);

  @override
  State<ViewAccount5> createState() => _ViewAccount5State();
}

class _ViewAccount5State extends State<ViewAccount5> {
  ...
  final String keepMePostedText = "Keep me posted";
  final Color keepMePostedTextColor = const Color(0xff404446);
  final String keepMePostedDetailText =
      "Find out when you have pending transaction and other notifications";
  final Color keepMePostedkDetailTextColor = const Color(0xff979C9E);
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: SizedBox(
                          ...
                          child: Center(
                              child: Text(
                            keepMePostedDetailText,
                            textAlign: TextAlign.center,
                            style: GoogleFonts.poppins(
                                fontSize: 14.h,
                                fontWeight: FontWeight.w500,
                                color: keepMePostedkDetailTextColor),
                          )),
                        ),
                      ),
                      const Spacer(),
